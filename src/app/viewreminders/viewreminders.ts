...
export class ViewRemindersPage  implements OnInit{
  ...
  ngOnInit() {
    ...
    this.fetchReminders();
    this.remaining();
   // this.loginID= this.globalVars.MAP_LOGIN_ID;
	}
  ...
  fetchReminders() {
    ...
    var objData = { login_id: this.globalVars.LoginID };
    ...
    this.connectServer.getData("FeedbackServlet/activitydetails", objData).then
      (
        ...
        //  console.log(this.fetchReminders());
