...
export class Feedback {
  ...
  details: Array<{}>;
  surveyDetails: { society_name: any, society_add: any, landmark: any, area: any, locality: any, pin_code: any, email: any, no_of_units: any, billingcycle: any, managerName: any, manager_contactNo: any, secretoryName: any, secretory_contactNo: any, Amount: any, perCycle: any, portalName: any, chargespaying: any, notes: any, activeStatus: any };
  ...
  constructor(
    ...
    this.area_Array = [];
    this.Locality_array = [];
    this.surveyDetails = { society_name: "", society_add: "", landmark: "", area: "", locality: "", pin_code: "", email: "", no_of_units: "", billingcycle: "", managerName: "", manager_contactNo: "", secretoryName: "", secretory_contactNo: "", Amount: "", perCycle: "", portalName: "", chargespaying: "", notes: "" , activeStatus: ""};
  ...
  GetArea() {
    var objData = [];
    objData['landmarkid'] = this.surveyDetails['landmark'];
  ...
  submit() {
    ...
    else if(this.surveyDetails.landmark.length == 0){
      this.message = "Please enter landmark";
    }
