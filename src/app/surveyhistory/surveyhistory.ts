...
export class SurveyhistoryPage implements OnInit {
  ViewsurveyPage : any ='viewsurvey';
  data_details: any;
  displayData = {};
  SurveyDetails = {};
  society_name: any;
  ...
  constructor(
    ...
    // data_details = this.route.getCurrentNavigation()?.extras?.state;
  ...
  ngOnInit(): void {
    ...
    this.route.queryParams.subscribe(params => {
      this.displayData = params["details"];
    ...
    this.connectServer
      ...
      .then(resolve => {
        ...
        if (resolve["success"] == 1) {
          ...
          this.pin_code = this.SurveyDetails["pin_code"];
          ...
          this.areaName = this.SurveyDetails["areaName"];
          this.localityName = this.SurveyDetails["localityName"];
