...
export class UpdatesurveyPage implements OnInit {
  SurveyhistoryPage : any ='surveyhistory';
  updateSurvey: { survey_id: any, societyName: any, societyAdd: any, Landmark: any, Area: any, locality: any, pincode: any, email: any, no_units: any, BillingCycle: any, managerName: any, managerContact: any, secretaryName: any, secContact: any, service_amount: any, cycle: any, portalName: any, charges: any, note: any, pin_code: any,  locality_name: any; };
  details: {};
  message: string;
  ...
  constructor(public navCtrl: NavController,
    ...
    this.updateSurvey = { survey_id: "", societyName: "", societyAdd: "", Landmark: "", Area: "", locality: "", pincode: "", email: "", no_units: "", BillingCycle: "", managerName: "", managerContact: "", secretaryName: "", secContact: "", service_amount: "", cycle: "", portalName: "", charges: "", note: "", pin_code: '', locality_name:"" };
    this.details = [];
    this.area_Array = [];
    this.Locality_array = [];
  }
  ...
  displayData(details) {
    ...
    this.updateSurvey.Area = this.details['area'];
    // alert(this.updateSurvey.Area);
    this.updateSurvey.locality = this.details['locality_id'];
    this.updateSurvey.locality_name = this.details['Locality'];
  ...
  GetArea() {
    var objData = [];
    objData['landmarkid'] = this.updateSurvey['landmark'];
    ...
    this.connectServer.getData("FeedbackServlet/fetchlocality", objData).then(
      resolve => {
        ...
        if (resolve['success'] == 1) {
          ...
          console.log("loaclity list ",localityList);
          this.Locality_array = [];
  ...
  fetchPincode() {
    ...
    var objData = [];
    objData['localityid'] = this.updateSurvey['locality_id'];
    // alert(objData['areaid']);
    // this.loaderView.showLoader('Loading ...');
